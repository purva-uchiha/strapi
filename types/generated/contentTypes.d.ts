...
export interface ApiAdminAdmin extends Schema.CollectionType {
  ...
  attributes: {
    cooking: Attribute.Relation<
      'api::admin.admin',
      'oneToOne',
      'api::cooking.cooking'
    >;
    approve: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiCookingCooking extends Schema.CollectionType {
  ...
  attributes: {
    Trained_Chef: Attribute.Boolean;
    Cuisines: Attribute.Text;
    Menu: Attribute.Text;
    Calendar_Management: Attribute.JSON;
    Diet: Attribute.JSON &
    ...
    Delivery_Charges: Attribute.String;
...
export interface ApiServiceProviderServiceProvider
  ...
  attributes: {
    ...
    Bank_Information: Attribute.Text;
    Background_Check: Attribute.Boolean;
    ...
    cooking: Attribute.Relation<
      ...
      'api::cooking.cooking'
    >;
    tutoring: Attribute.Relation<
      'api::service-provider.service-provider',
      'oneToMany',
      'api::tutoring.tutoring'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiTutoringTutoring extends Schema.CollectionType {
  ...
  attributes: {
    Trained_Teacher: Attribute.Boolean;
    Grade: Attribute.String;
    Subject_Pricing: Attribute.String;
    Location: Attribute.JSON &
      Attribute.CustomField<
        'plugin::multi-select.multi-select',
        ['Online', 'Offline', '']
